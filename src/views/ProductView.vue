...
const products = ref<Product[]>([
  {
    ...
    description:
      'A scalable, secure web platform built for enterprise-level businesses. Features include multi-tenant architecture, real-time analytics, and seamless third-party integrations.',
  ...
  },
  {
    ...
    description:
      'Cross-platform mobile applications that deliver native-like performance. Built with React Native and Flutter for iOS and Android platforms.',
  ...
  },
  {
    ...
    category: 'DevOps',
    description:
      'End-to-end cloud infrastructure setup and management on AWS, Azure, or GCP. Includes CI/CD pipelines, monitoring, and auto-scaling configurations.',
  ...
  },
  {
    ...
    description:
      'Harness the power of artificial intelligence to gain actionable insights from your data. Custom ML models tailored to your business needs.',
  ...
  },
  {
    ...
    category: 'Design',
    description:
      'Comprehensive design systems that ensure consistency across all your digital products. Includes component libraries, style guides, and prototyping.',
  ...
  },
  {
    ...
    category: 'Security',
    description:
      'Protect your digital assets with our comprehensive security solutions. Includes penetration testing, vulnerability assessments, and security audits.',
    ...
    <section class="bg-gradient-to-br from-primary-900 to-primary-800 py-20 lg:py-28">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-lg sm:text-xl text-primary-100 max-w-3xl mx-auto leading-relaxed">
          Discover our comprehensive range of digital solutions designed to help your business
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div
            ...
            :key="product.id"
            class="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col"
          >
            <!-- Image -->
            <div class="relative overflow-hidden aspect-[3/2]">
              ...
              <div class="absolute top-4 left-4">
                <span
                  class="px-3 py-1 bg-white/90 backdrop-blur-sm rounded-full text-xs font-semibold text-gray-700"
                >
                  {{ product.category }}
                </span>
              </div>
            ...
            <div class="p-6 flex-1 flex flex-col">
              ...
              <button
                ...
                class="w-full inline-flex items-center justify-center px-5 py-3 text-sm font-medium text-primary-700 bg-primary-50 rounded-xl hover:bg-primary-100 transition-colors group/btn"
              >
                Learn More
                <svg
          ...
          >
            ...
            <div class="p-6 sm:p-8">
              ...
              <div class="flex flex-col sm:flex-row gap-4">
                ...
                <button
                  @click="closeProductModal"
                  class="flex-1 inline-flex items-center justify-center px-6 py-3.5 text-base font-semibold text-gray-700 bg-gray-100 rounded-xl hover:bg-gray-200 transition-colors"
                >
                  Close
                </button>
              </div>
