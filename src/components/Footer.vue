...
const services = ["Ducting", "Parts", "Accessories", "Installation"];
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        ...
        <div>
          ...
          <ul class="space-y-3">
            <li class="flex items-start space-x-3">
              ...
              <span class="text-gray-400 text-sm"> Rukan Sunter Permai Blok D1-2<br />Jakarta Utara 14350, Indonesia </span>
            </li>
            <li class="flex items-center space-x-3">
              <svg class="w-5 h-5 text-primary-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
              <span class="text-gray-400 text-sm">myllmulyanto56@gmail.com</span>
            </li>
            <li class="flex items-center space-x-3">
              <svg class="w-5 h-5 text-primary-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path
              ...
              <span class="text-gray-400 text-sm">+62 853-1208-4879</span>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div class="mt-12 pt-8 border-t border-gray-800">
        <div class="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
          <p class="text-gray-500 text-sm">&copy; {{ currentYear }} Ducting FirstDuct. All rights reserved.</p>
